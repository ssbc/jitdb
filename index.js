...
module.exports = function (log, indexesPath) {
  ...
  const B_TIMESTAMP = bipf.allocAndEncode('timestamp')
  const B_SEQUENCE = bipf.allocAndEncode('sequence')
  const B_VALUE = bipf.allocAndEncode('value')
  ...
  function checkComparison(op, buffer) {
    const pValue = bipf.seekKey2(buffer, 0, B_VALUE, 0)
  ...
  function matchAgainstPrefix(op, prefixIndex, cb) {
    ...
    function checker(value) {
      ...
      const pValue = bipf.seekKey2(value, 0, B_VALUE, 0)
